...
.method protected collectBodyParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V
    ...
    invoke-static {v1}, Lcom/parse/signpost/OAuth;->decodeForm(Ljava/io/InputStream;)Lcom/parse/signpost/http/HttpParameters;

    move-result-object v2

    const/4 v3, 0x1

    invoke-virtual {p2, v2, v3}, Lcom/parse/signpost/http/HttpParameters;->putAll(Ljava/util/Map;Z)V
...
.method protected collectHeaderParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V
    ...
    invoke-static {v1}, Lcom/parse/signpost/OAuth;->oauthHeaderToParamsMap(Ljava/lang/String;)Lcom/parse/signpost/http/HttpParameters;

    move-result-object v0

    .line 224
    .local v0, headerParams:Lcom/parse/signpost/http/HttpParameters;
    const/4 v1, 0x0
...
.method protected collectQueryParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V
    ...
    invoke-static {v2}, Lcom/parse/signpost/OAuth;->decodeForm(Ljava/lang/String;)Lcom/parse/signpost/http/HttpParameters;
...
.method public sign(Lcom/parse/signpost/http/HttpRequest;)Lcom/parse/signpost/http/HttpRequest;
    ...
    .prologue
    .line 84
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->consumerKey:Ljava/lang/String;

    if-nez v2, :cond_0

    .line 85
    new-instance v2, Lcom/parse/signpost/exception/OAuthExpectationFailedException;

    const-string v3, "consumer key not set"

    invoke-direct {v2, v3}, Lcom/parse/signpost/exception/OAuthExpectationFailedException;-><init>(Ljava/lang/String;)V

    throw v2

    .line 87
    :cond_0
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->consumerSecret:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    .line 93
    :try_start_0
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->additionalParameters:Lcom/parse/signpost/http/HttpParameters;
    ...
    iget-object v3, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->additionalParameters:Lcom/parse/signpost/http/HttpParameters;

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Lcom/parse/signpost/http/HttpParameters;->putAll(Ljava/util/Map;Z)V

    .line 96
    :cond_2
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-virtual {p0, p1, v2}, Lcom/parse/signpost/AbstractOAuthConsumer;->collectHeaderParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V

    .line 97
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-virtual {p0, p1, v2}, Lcom/parse/signpost/AbstractOAuthConsumer;->collectQueryParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V

    .line 98
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-virtual {p0, p1, v2}, Lcom/parse/signpost/AbstractOAuthConsumer;->collectBodyParameters(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)V

    .line 101
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-virtual {p0, v2}, Lcom/parse/signpost/AbstractOAuthConsumer;->completeOAuthParameters(Lcom/parse/signpost/http/HttpParameters;)V
    ...
    invoke-virtual {v2, v3}, Lcom/parse/signpost/http/HttpParameters;->remove(Ljava/lang/Object;)Ljava/util/SortedSet;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    .line 109
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->messageSigner:Lcom/parse/signpost/signature/OAuthMessageSigner;

    iget-object v3, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-virtual {v2, p1, v3}, Lcom/parse/signpost/signature/OAuthMessageSigner;->sign(Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)Ljava/lang/String;
    ...
    .line 112
    iget-object v2, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->signingStrategy:Lcom/parse/signpost/signature/SigningStrategy;

    iget-object v3, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->requestParameters:Lcom/parse/signpost/http/HttpParameters;

    invoke-interface {v2, v1, p1, v3}, Lcom/parse/signpost/signature/SigningStrategy;->writeSignature(Ljava/lang/String;Lcom/parse/signpost/http/HttpRequest;Lcom/parse/signpost/http/HttpParameters;)Ljava/lang/String;
    ...
    invoke-interface {p1, v3}, Lcom/parse/signpost/http/HttpRequest;->getHeader(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, Lcom/parse/signpost/OAuth;->debugOut(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/parse/signpost/exception/OAuthCommunicationException;

    invoke-direct {v2, v0}, Lcom/parse/signpost/exception/OAuthCommunicationException;-><init>(Ljava/lang/Exception;)V
...
.method public sign(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 126
    new-instance v1, Lcom/parse/signpost/basic/UrlStringRequestAdapter;

    invoke-direct {v1, p1}, Lcom/parse/signpost/basic/UrlStringRequestAdapter;-><init>(Ljava/lang/String;)V

    .line 129
    .local v1, request:Lcom/parse/signpost/http/HttpRequest;
    iget-object v0, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->signingStrategy:Lcom/parse/signpost/signature/SigningStrategy;

    .line 130
    .local v0, oldStrategy:Lcom/parse/signpost/signature/SigningStrategy;
    ...
    .line 132
    invoke-virtual {p0, v1}, Lcom/parse/signpost/AbstractOAuthConsumer;->sign(Lcom/parse/signpost/http/HttpRequest;)Lcom/parse/signpost/http/HttpRequest;

    .line 135
    iput-object v0, p0, Lcom/parse/signpost/AbstractOAuthConsumer;->signingStrategy:Lcom/parse/signpost/signature/SigningStrategy;

    .line 137
    invoke-interface {v1}, Lcom/parse/signpost/http/HttpRequest;->getRequestUrl()Ljava/lang/String;
...
.method protected abstract wrap(Ljava/lang/Object;)Lcom/parse/signpost/http/HttpRequest;
.end method
