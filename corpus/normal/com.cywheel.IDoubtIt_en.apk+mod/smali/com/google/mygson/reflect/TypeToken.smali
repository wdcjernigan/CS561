.class public Lcom/google/mygson/reflect/TypeToken;
...
.method protected constructor <init>()V
    ...
    .prologue
    .line 61
    .local p0, this:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<TT;>;"
    ...
    invoke-static {v0}, Lcom/google/mygson/reflect/TypeToken;->getSuperclassTypeParameter(Ljava/lang/Class;)Ljava/lang/reflect/Type;

    move-result-object v0

    iput-object v0, p0, Lcom/google/mygson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    .line 63
    iget-object v0, p0, Lcom/google/mygson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    invoke-static {v0}, Lcom/google/mygson/internal/$Gson$Types;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v0

    iput-object v0, p0, Lcom/google/mygson/reflect/TypeToken;->rawType:Ljava/lang/Class;
    ...
    iput v0, p0, Lcom/google/mygson/reflect/TypeToken;->hashCode:I
...
.method constructor <init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-static {v0}, Lcom/google/mygson/internal/$Gson$Types;->canonicalize(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
...
.method public static get(Ljava/lang/Class;)Lcom/google/mygson/reflect/TypeToken;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    new-instance v0, Lcom/google/mygson/reflect/TypeToken;

    invoke-direct {v0, p0}, Lcom/google/mygson/reflect/TypeToken;-><init>(Ljava/lang/reflect/Type;)V

    return-object v0
.end method

.method public static get(Ljava/lang/reflect/Type;)Lcom/google/mygson/reflect/TypeToken;
    .locals 1
    .parameter "type"
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static getSuperclassTypeParameter(Ljava/lang/Class;)Ljava/lang/reflect/Type;
    ...
    invoke-static {v2}, Lcom/google/mygson/internal/$Gson$Types;->canonicalize(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
...
.method private static isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericArrayType;)Z
    ...
    invoke-static {v1, v2, v3}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
...
.method private static isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    .line 197
    :cond_1
    invoke-static/range {p0 .. p0}, Lcom/google/mygson/internal/$Gson$Types;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {v9, v0, v1}, Lcom/google/mygson/reflect/TypeToken;->typeEquals(Ljava/lang/reflect/ParameterizedType;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v7, v0, v15}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v10, v0, v15}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
...
.method private static typeEquals(Ljava/lang/reflect/ParameterizedType;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v4, v5, p2}, Lcom/google/mygson/reflect/TypeToken;->matches(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/util/Map;)Z
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 284
    .local p0, this:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<TT;>;"
    instance-of v0, p1, Lcom/google/mygson/reflect/TypeToken;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/mygson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    check-cast p1, Lcom/google/mygson/reflect/TypeToken;

    .end local p1
    iget-object v1, p1, Lcom/google/mygson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    invoke-static {v0, v1}, Lcom/google/mygson/internal/$Gson$Types;->equals(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)Z
...
.method public final getRawType()Ljava/lang/Class;
    ...
    .line 94
    .local p0, this:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<TT;>;"
    iget-object v0, p0, Lcom/google/mygson/reflect/TypeToken;->rawType:Ljava/lang/Class;
...
.method public final hashCode()I
    ...
    .line 280
    .local p0, this:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<TT;>;"
    iget v0, p0, Lcom/google/mygson/reflect/TypeToken;->hashCode:I

    return v0
.end method

.method public isAssignableFrom(Lcom/google/mygson/reflect/TypeToken;)Z
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 153
    .local p0, this:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<TT;>;"
    .local p1, token:Lcom/google/mygson/reflect/TypeToken;,"Lcom/google/mygson/reflect/TypeToken<*>;"
    invoke-virtual {p1}, Lcom/google/mygson/reflect/TypeToken;->getType()Ljava/lang/reflect/Type;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;)Z
...
.method public isAssignableFrom(Ljava/lang/Class;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;)Z
...
.method public isAssignableFrom(Ljava/lang/reflect/Type;)Z
    ...
    invoke-static {p1}, Lcom/google/mygson/internal/$Gson$Types;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {p1, v0, v1}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {p1, v0}, Lcom/google/mygson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericArrayType;)Z
    ...
    invoke-static {v0, v3}, Lcom/google/mygson/reflect/TypeToken;->buildUnexpectedTypeError(Ljava/lang/reflect/Type;[Ljava/lang/Class;)Ljava/lang/AssertionError;
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/mygson/internal/$Gson$Types;->typeToString(Ljava/lang/reflect/Type;)Ljava/lang/String;
