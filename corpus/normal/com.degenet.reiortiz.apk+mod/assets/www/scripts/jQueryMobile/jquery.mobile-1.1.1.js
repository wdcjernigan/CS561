	...
	return function( name, reverse, $to, $from ) {
		...
		var deferred = new $.Deferred(),
			...
			doneOut = function() {
 			...
 			//MOD (ROR): fixed startIn function to eliminate flickering then transitioning slides.
			startIn = function(){	
...
(function( $, undefined ) {
	...
	$.widget( "mobile.fixedtoolbar", $.mobile.widget, {
		...
		toggle: function(){
			...
			//MOD (ROR): uncomment to avoid fixed toolbar flickering when clicking on content div
