...
(function($) {
    $.jQTouch = function(options) {
        ...
        var $body,
            ...
            defaults = {
                addGlossToIcon: true,
                backSelector: '.back, .back_dies, .back_actes, .back_serveis, .cancel, .goback',
                cacheGetRequests: false, //aquest es el que permet cridar cada cop una pagina externa nova
                debug: true,
        ...
        function insertPages(nodes, animation) {
            ...
            $(nodes).each(function(index, node) {
            	...
            	//fpmWEB - modificacio per fer swipe a les imatges via ajax
